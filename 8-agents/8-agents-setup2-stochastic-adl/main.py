...
lamb = [[5.0672,4.4150,5.0967,5.1631],[4.5686,4.9671,4.9942,4.6172],[3.3972,3.6215,3.3983,4.4020],[2.6044,2.4534,3.6837,2.6472],[0.0201,1.7532,7.8576,3.6710],[ 0,0.7350,8.6901,5.7239],[0.0000,0.5410,6.5965,4.3712],[0,0.0000,6.0057,3.6077]] # guess we have to put the lambda values
...
for i in range(num_of_agents):
	...
	#agents.append(DQN_Agent_Constant_Price(names[i],state_size, max_battery, max_energy_generated, max_received, min_non_adl, max_non_adl, grid_price, total_iterations-100000, 0, lamb[i]))

# initialisations for the state of each agent
states_price = []
states_adl = []
...
for Iter in range(total_iterations):
    ...
    # Rewards for not satisfying the ADL demands by the the agents and updating the ADL state of the microgrids
