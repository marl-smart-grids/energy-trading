...
class DQN_Agent:
    ...
    # Takes a pricing action based on the available action indexes using an epsilon greedy policy(either choose a random action with epsilon proabilty
    ...
    # Randomisation for ADL demand also happens here. At the start of the day(time == 4) the ADL demands are randomly selected 
